...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template name="colourtexttorgb">
		...
		<xsl:choose>
			...
			<xsl:when test="$name = 'dark_blue'"><xsl:text>#004890</xsl:text></xsl:when><!-- data code 04 -->
			<xsl:when test="$name = 'dark_green'"><xsl:text>#006351</xsl:text></xsl:when><!-- data code 05 -->
			<xsl:when test="$name = 'emerald_green' or $name = 'green'"><xsl:text>#1fb259</xsl:text></xsl:when><!-- data code 06 -->
			<xsl:when test="$name = 'grey'"><xsl:text>#959ca1</xsl:text></xsl:when><!-- data code 07 -->
			<xsl:when test="$name = 'light_blue'"><xsl:text>#a0cced</xsl:text></xsl:when><!-- data code 08 -->
			<xsl:when test="$name = 'light_green'"><xsl:text>#6db43e</xsl:text></xsl:when><!-- data code 09 -->
			...
			<xsl:when test="$name = 'orange' or $name = 'amber'"><xsl:text>#f78e1e</xsl:text></xsl:when><!-- data code 12 -->
			<xsl:when test="$name = 'pink' or $name = 'cyclamen'"><xsl:text>#fac8ca</xsl:text></xsl:when><!-- data code 13 -->
			...
			<xsl:when test="$name = 'royal_blue'"><xsl:text>#0068b3</xsl:text></xsl:when><!-- data code 16 -->
			<xsl:when test="$name = 'white'"><xsl:text>#ffffff</xsl:text></xsl:when><!-- data code 17 -->
			<xsl:when test="$name = 'yellow' or $name = 'gold'"><xsl:text>#fff352</xsl:text></xsl:when><!-- data code 18 -->
	...
	<xsl:template match="body[pattern = 'stripe' or pattern = 'panel']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'stripes' or pattern = 'striped']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'hoops' or pattern = 'hooped']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'halve' or pattern = 'halved']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'cross_belts' or pattern = 'cross_sashes']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'cross_of_lorraine']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'maltese_cross']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'inverted_triangle']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'large_spots']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'triple_diamond']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="body[pattern = 'hollow_box']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="sleeve[pattern = 'hooped' or pattern = 'hoops']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
	...
	<xsl:template match="sleeve[pattern = 'halves' or pattern = 'halved']">
		<xsl:param name="fillcolor"/>
		<g>
			<xsl:attribute name="id">
